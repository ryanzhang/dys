...
class TestBylyStrategy:
    ...
    def byly(self):
        ...
        byly.set_metric_folder(os.getcwd() + "/starget/30")
    ...
    def test_get_detail_metric_by_export_file(self, byly: BylyStrategy):
        ...
        directory = os.getcwd() + "/resources/byly/30"
        output_directory = os.getcwd() + "/starget"
        for filename in os.listdir(directory):
            f = os.path.join(directory, filename)
            obf = os.path.join(output_directory, "buy_30_" + filename)
