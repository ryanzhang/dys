...
class TestStockUtil:
    ...
    def test_get_trade_day_by_offset(self, util:StockUtil):
        assert util.get_trade_day_by_offset(date(2022,1,28), 1) == date(2022,1,27)
        assert util.get_trade_day_by_offset(date(2022,1,28), 2) == date(2022,1,26)
        assert util.get_trade_day_by_offset(date(2022,1,28), 5) == date(2022,1,21)
        assert util.get_trade_day_by_offset(date(2022,1,29), 1) == date(2022,1,27)

        assert util.get_trade_day_by_offset(date(2022,1,28), -1) == date(2022,2,7)
        assert util.get_trade_day_by_offset(date(2022,1,29), -1) == date(2022,2,8)
